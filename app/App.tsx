...
import AdminContractorParticipationScreen from './src/screens/AdminContractorParticipationScreen';
import AdminContractorParticipationDetailScreen from './src/screens/AdminContractorParticipationDetailScreen';
...
export type RootStackParamList = {
  ...
  ContractorLeadRequest: { selectedContractor?: any; troubleshootingSessionId?: string; leadDefaults?: any } | undefined;
  ...
  AdminContractorParticipation: undefined;
  AdminContractorParticipationDetail: { contractorId: string };
};
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        ...
        <Stack.Screen name="ContractorLeadPreferences" component={ContractorLeadPreferencesScreen} options={{ title: 'Participation Settings' }} />
        ...
        <Stack.Screen name="AdminContractorParticipation" component={AdminContractorParticipationScreen} options={{ title: 'Participation Controls' }} />
        <Stack.Screen name="AdminContractorParticipationDetail" component={AdminContractorParticipationDetailScreen} options={{ title: 'Edit Participation' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
